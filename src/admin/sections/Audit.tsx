...
const actions: Record<string, string> = { 'client.verified': 'Client vérifié', 'agency.approved': 'Agence approuvée', 'agency.rejected': 'Agence refusée', 'agency.needs_changes': 'Correction demandée', 'agency.pending': 'Dossier remis en attente', 'reservation.updated': 'Réservation modifiée', 'payment.updated': 'Paiement modifié' }

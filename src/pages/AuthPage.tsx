...
export function AuthPage({ signup = false }: { signup?: boolean }) {
  ...
  return <AccountLayout auth title={signup ? 'Inscription' : 'Connexion'}>
    ...
    {(!signup || fields.role === 'client') && !session && <button className="button account-google" disabled={busy || loading || !!sessionError} onClick={() => void google()}>Continuer avec Google</button>}
